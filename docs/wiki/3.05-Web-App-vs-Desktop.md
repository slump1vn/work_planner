...
In the web version, time tracking only works while the app is open. Idle time tracking in the browser requires the Work Planner Chrome Extension to be installed.
...
Jira integration and idle time tracking in the web version require the Work Planner Chrome Extension to be installed.
