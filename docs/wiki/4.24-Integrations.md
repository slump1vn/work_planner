...
- Add them as tasks in Work Planner with one click.
...
**Sync providers** handle **data synchronization** between devices (or between the app and a backup location). They do not import issues; they sync your existing Work Planner data (tasks, projects, time tracking, settings, and so on). Supported options include:
...
- **Privacy** — Integrations talk directly to your chosen services (Jira, GitHub, your WebDAV server, etc.). The app does not send your data to Work Planner servers; configuration and synced data stay under your control and in the storage you choose.
