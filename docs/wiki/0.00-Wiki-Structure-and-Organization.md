...
This section contain Tutorials/Playbooks/Quickstarts. These are intended to _teach_ and will draw upon material in other sections as needed to achieve that goal. The first, and at present only, Quickstart is [[1.01-First-Steps]]. It is very similar to [this article by Johannes](https://dev.to/johannesjo/getting-started-with-super-productivity-2791). Some of the articles on the Work Planner site could be adapted such that they contain more interlinking with the wiki:
