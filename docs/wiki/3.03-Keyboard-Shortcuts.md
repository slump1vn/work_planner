...
Work Planner supports an extensive keyboard shortcut system. Shortcuts are grouped by function, and most are user-configurable via [[3.02-Settings-and-Preferences]].
